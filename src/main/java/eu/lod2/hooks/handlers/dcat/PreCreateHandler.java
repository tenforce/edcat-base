 ...
 * The name for this hook is {@code "eu.lod2.hooks.handlers.dcat.PreCreateHandler"}.
 */
...
public interface PreCreateHandler extends HookHandler {
   ...
   * @throws ActionAbortException Throwing this exception will abort the CREATE action.
