...
/**
 * Implement if you are a provider for the PostUpdateHook for DataSets.
 * <p/>
 ...
 * The name for this hook is {@code "eu.lod2.hooks.handlers.dcat.dataset.PostUpdateHandler"}.
 */
@SuppressWarnings( "UnusedDeclaration" )
public interface PostUpdateHandler extends HookHandler {

  /**
   * Called after an UPDATE action on a DataSet is finished, yet before the response is
