...
/**
 * Implement if you are a provider for the PostCreateHook for DataSets.
 * <p/>
 ...
 * The name for this hook is {@code "eu.lod2.hooks.handlers.dcat.dataset.PostCreateHandler"}.
 */
@SuppressWarnings( "UnusedDeclaration" )
public interface PostCreateHandler extends HookHandler {

  /**
   * Called after a CREATE action on a DataSet is finished, yet before the response is
